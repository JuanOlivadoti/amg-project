...
export class ApiService {
  ...
  readonly verPost = this.cliente.verPost;
  readonly editarPost = this.cliente.editarPost;
  readonly solicitarPublicacionPost = this.cliente.solicitarPublicacionPost;
