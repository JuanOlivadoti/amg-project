...
## Cobertura actual: 1395 tests (monorepo) + 403 (portal)
...
> `npm run verificar -- --con-portal` en verde de punta a punta (entorno, arnés, secretos, typecheck,
> los 7 paquetes + `scripts/`, y el portal), no una suma por paquete.
