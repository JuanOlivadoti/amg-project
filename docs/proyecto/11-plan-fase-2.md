...
- **880 tests** (monorepo). Los de seguridad corren contra Postgres real (PGlite en WASM), sin Docker ni cuenta.
...
**Postgres decida el resto** (ADR-15). 113 tests contra PGlite, sin red ni Supabase.
