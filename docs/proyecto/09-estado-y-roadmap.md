...
| **Tests** | **1278** — 935 en el monorepo + 343 en el portal (236 `node:test` + 107 Karma). Los de seguridad, contra Postgres real. Medido el **2026-08-08** con `npm run verificar` tras la 15ª review, los bloques A, B, C0 y los pasos **C-0** y **C-0b** del plan (venía de 1199). El portal, con `-- --con-portal` y Karma aparte. |
