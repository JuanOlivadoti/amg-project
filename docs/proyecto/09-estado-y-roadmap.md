...
| **Tests** | **1229** — 910 en el monorepo + 319 en el portal (225 `node:test` + 94 Karma). Los de seguridad, contra Postgres real. Medido el **2026-08-07** con `npm run verificar` tras la 15ª review y el bloque A del plan (venía de 880: +2 de la guarda de `finishRun`, +16 del barrido, +12 de la sonda de `/_health`); el portal con `-- --con-portal` y Karma aparte, sin cambios. |
