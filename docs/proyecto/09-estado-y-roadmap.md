...
| **Tests** | **1282** — 938 en el monorepo + 344 en el portal (237 `node:test` + 107 Karma). Los de seguridad, contra Postgres real. Medido el **2026-08-08** con `npm run verificar` tras la 15ª review y los bloques A (**A4 incluido**), B y **C entero** (venía de 1199). El portal, con `-- --con-portal` y Karma aparte. |
