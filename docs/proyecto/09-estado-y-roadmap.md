...
| **Tests** | **505** en el monorepo + **87** en el portal. Los de seguridad, contra Postgres real |
...
| ✅ | **505 tests en verde** + typecheck limpio en los 6 paquetes. Los de seguridad, contra Postgres real. |
