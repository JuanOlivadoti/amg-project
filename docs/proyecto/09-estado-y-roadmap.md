...
>
> **El orden de trabajo que sigue:** queda el tercer y último ítem del lote corto —**verificar el
> snapshot estático**— y después la pieza grande, **comparativas de seguros** (spec aprobada, falta el
> plan). El detalle, en [`15-plan-plataforma.md`](15-plan-plataforma.md) § El orden que recomiendo.
>
...
>
> **El orden de trabajo vigente** —lote corto de cierre y después comparativas de seguros— está en
