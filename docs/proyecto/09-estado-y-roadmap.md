...
> (`progress/informes/revision-publicar-respuesta.md`). El resto de la fase 2 (alertas WhatsApp/email,
> acceso real a Google, limpieza de token revocado) queda bloqueado en cascada por un trámite externo
> de Juan (pedir acceso a la Business Profile API) o por elegir proveedor de alertas — ninguno de los
> dos es ingeniería lista para hacer. Detalle en
