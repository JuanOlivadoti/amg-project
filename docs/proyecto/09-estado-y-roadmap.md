...
| **Tests** | **508** en el monorepo + **87** en el portal. Los de seguridad, contra Postgres real |
...
| ✅ | **508 tests en verde** + typecheck limpio en los 6 paquetes. Los de seguridad, contra Postgres real. |
