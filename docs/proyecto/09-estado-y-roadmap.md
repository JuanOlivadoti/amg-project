...
>
> **El orden de trabajo que sigue** (decidido el mismo día): quedan la **reescritura de ADR-11** y
> **verificar el snapshot estático** como entregable, y después la pieza grande, **comparativas de
> seguros** (spec aprobada, falta el plan). El detalle, en
