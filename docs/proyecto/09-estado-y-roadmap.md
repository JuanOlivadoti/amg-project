...
| **Tests** | **1464** — 1120 en el monorepo + 344 en el portal (237 `node:test` + 107 Karma). Los de seguridad, contra Postgres real. Medido el **2026-08-08** con `npm run verificar` tras la 15ª review, los bloques A (**A4 incluido**), B y **C entero**, y las **entregas 1 y 2 del bloque E** (venía de 1199 → 1282 → 1345 → 1464). El portal, con `-- --con-portal` y Karma aparte. |
