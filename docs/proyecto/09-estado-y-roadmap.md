...
> iniciativa de generalización quedan con código implementado y en `main`** — falta coordinar el
> despliegue a producción de las seis migraciones pendientes (`0027`-`0031`) y la decisión de negocio
> de encender `destinoPosts`/multi-vertical en `environment.prod.ts`.
>
