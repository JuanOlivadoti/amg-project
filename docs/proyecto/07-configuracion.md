...
**Los siete paquetes** corren de punta a punta **sin una sola API key ni contraseña**: providers
...
es lo que permite que los 743 tests corran en CI sin Docker, sin cuenta y sin red.
