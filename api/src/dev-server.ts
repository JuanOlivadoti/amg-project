...
import { aplicarMigraciones, ConexionReservada, PglitePool, PgStore, PgClientes, sembrarDemo } from "db";
...
const app = createApp({ store, clientes, emisor, verificar, corsOrigins: ["http://localhost:4200"] });
