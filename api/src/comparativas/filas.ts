 ...
 * —cada correduría trae sus propias columnas— así que esta función no interpreta el contenido: solo
 * convierte texto a filas sin corromperlo. Interpretar el contenido es trabajo del provider de LLM
 * (Task 4/5), no de este módulo.
 *
 ...
 * comillas). No interpreta el contenido de los campos: los devuelve tal como vienen.
 */
